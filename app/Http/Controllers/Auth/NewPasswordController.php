...
class NewPasswordController extends Controller
{
    ...
    public function store(Request $request): RedirectResponse
    {
        ...
        // Si la contraseña se restablece correctamente, redirigiremos al usuario a la vista autenticada
        // del inicio de la aplicación. Si hay un error, podemos redirigirlo de vuelta a de dónde
        // vino con su mensaje de error.
